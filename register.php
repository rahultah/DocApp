...
if (isset($_POST['submit']))
{
    ...
    echo $num;
    if ($num > 0) {
        header('location: register.php?error=1&msg=User Already Exist');
    }
    else
    {
        $inserq = "INSERT INTO `doctors`( `name`, `email`, `password`,`phone`, `dob`, `aLine1`, `aLine2`, `country`, `state`, `city`, `zipcode`, `degree`, `status`) VALUES ('$fullName','$email','$hash','$phone','$date','$aLine1','$aLine2','$country','$state','$city','$zipcode','$degree','0')";
        $result = mysqli_query($conn, $inserq);
        header('location: register.php?success=1&msg=Doctor Successfully Signed up. Please wait for the Admin to approve the account to login');
        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl -900">REGISTER</h1>
                ...
                <div id="page1" style="display: block;">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline -400 text-lg"></i></div>
                                <input name="fname" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-none focus:border-indigo-500" placeholder="John">
                            </div>
                        </div>
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline -400 text-lg"></i></div>
                                <input name="lname" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline -400 text-lg"></i></div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline -400 text-lg"></i></div>
                                <input name="phone" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="9123456789">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline -400 text-lg"></i></div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline -400 text-lg"></i></div>
                                <input type="date" name="date1" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-xs font-semibold px-1">Address Line 1</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline -400 text-lg"></i></div>
                                <input type="text" name="aLine1" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Ex: - Civil Lines.,">
                            </div>
                        </div>
                </div>
                <!-- ---------- -->
                <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-xs font-semibold px-1">Address Line 2</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline -400 text-lg"></i></div>
                                <input type="text" name="aLine2" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Ex: - FC Road.,">
                            </div>
                        </div>
                </div>
                <!-- ---------- -->
                <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline -400 text-lg"></i></div>
                                <input type="text" name="country" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Ex: - India">
                            </div>
                        </div>
                </div>
                <!-- ---------- -->
                <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline -400 text-lg"></i></div>
                                <input type="text" name="state" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Ex: - Maharashtra">
                            </div>
                        </div>
                </div>
                <!-- ---------- -->
                <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline -400 text-lg"></i></div>
                                <input type="text" name="city" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Ex: - Pune">
                            </div>
                        </div>
                </div>
                <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-xs font-semibold px-1">Zipcode</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline -400 text-lg"></i></div>
                                <input type="text" name="zipcode" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Ex: - 440012">
                            </div>
                        </div>
                </div>
                <!-- ---------- -->
                <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-xs font-semibold px-1">Degree</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline -400 text-lg"></i></div>
                                <input type="text" name="degree" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="MBBS, BDS, etc.,">
                            </div>
                        </div>
                </div> 
                ...
                <div id="steps">
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5 ">
                            <div class="ml-8">
                            <button type="button" onclick="changePage('prev')" class="btn btn-primary">Previous</button>
                        ...
                        <div class="w-1/2 px-3 mb-5">
                            <div class="w-1/2 px-3 mb-5">
                            <div class="ml-16">
                            <button type="button" onclick="changePage('next')" class="btn btn-primary">Next</button>
                    ...
                    <div class="flex -mx-3">
                        ...
                        <ul class="w-full steps">
                            <li id="step1" class="step step-primary">Basic Info</li> 
                            <li id="step2" class="step ">Additional Info</li> 
